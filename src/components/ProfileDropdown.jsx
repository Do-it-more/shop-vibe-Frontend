...
const ProfileDropdown = () => {
    ...
    useEffect(() => {
        ...
        // Use touchstart for mobile responsiveness to avoid ghost clicks vs mousedown
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ...
                className="flex items-center gap-2 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors focus:outline-none relative z-50 touch-manipulation"
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed top-24 left-4 right-4 md:absolute md:inset-auto md:right-0 md:top-full md:mt-3 md:w-80 md:left-auto bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden z-50 origin-top-right fixed-mobile-dropdown"
                        >
